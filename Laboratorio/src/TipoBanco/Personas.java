...
public class Personas {
	...
	public static Personas of() {
		if (Personas.gestorDePersonas == null)
			Personas.gestorDePersonas = Personas.parse("src/TipoBanco/personas.txt");
	...
	public static void main(String[] args) {
		...
		System.out.println(File2.getFileCharset("src/TipoBanco/personas.txt"));
		...
		System.out.println("_________");
		Personas personas = Personas.parse("src/TipoBanco/personas.txt");
